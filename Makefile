...
SOURCES += $(GLUTIL_DIR)/lib/Camera.cpp $(GLUTIL_DIR)/lib/Mesh.cpp $(GLUTIL_DIR)/lib/Matrix2D.cpp $(GLUTIL_DIR)/lib/Shader.cpp $(GLUTIL_DIR)/lib/Texture.cpp $(GLUTIL_DIR)/lib/TextureCache.cpp
