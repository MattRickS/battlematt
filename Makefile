...
BUILD_DIR = build
SOURCES = $(SRC_DIR)/main.cpp $(SRC_DIR)/Application.cpp $(SRC_DIR)/Resources.cpp $(SRC_DIR)/Scene.cpp $(SRC_DIR)/Shape2D.cpp $(SRC_DIR)/Token.cpp $(SRC_DIR)/BGImage.cpp $(SRC_DIR)/Grid.cpp $(SRC_DIR)/UI.cpp $(SRC_DIR)/Overlays.cpp $(SRC_DIR)/stb_image.cpp $(SRC_DIR)/glad.c
